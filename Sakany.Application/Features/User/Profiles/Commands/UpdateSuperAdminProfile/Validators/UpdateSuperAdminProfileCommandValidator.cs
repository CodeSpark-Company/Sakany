...
namespace Sakany.Application.Features.User.Profiles.Commands.UpdateSuperAdminProfile.Validators
{
    public class UpdateSuperAdminProfileCommandValidator : AbstractValidator<UpdateSuperAdminProfileCommandRequest>
    {
        #region Properties
        ...
        public UpdateSuperAdminProfileCommandValidator(UserManager<ApplicationUser> userManager)
        {
